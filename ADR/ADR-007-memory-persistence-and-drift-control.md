...
IO-III's quality depends on **stable persona behaviour** and **consistent policy enforcement** over time.
...
- behavioural drift (tone/style rules gradually erode),
...
This reduces risk and clarifies behaviour.
...
### §4 Provenance labelling is mandatory
...
- periodic "behaviour audit" prompts (scheduled/manual),
...
- Easier to reason about behaviour changes
...
### Option A — Always-on long-term memory
Rejected:
- privacy risk,
- drift risk,
- hard to audit.

### Option B — No persistence at all
Rejected:
- loses useful continuity,
- makes operational workflows harder.

### Option C — Repo-canonical memory + optional local session memory (selected)
Accepted:
